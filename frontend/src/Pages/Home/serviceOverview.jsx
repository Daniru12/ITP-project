...
import ReviewsList from "../../Components/ServiceReviewsList";
...
const ServiceOverview = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/users/service/${id}`, {
        headers: {
              ...
              <div className="h-[400px] relative">
                <img
                  src={
                    ...
                    "https://via.placeholder.com/800x400?text=Pet+Service"
                  }
              ...
              <div className="flex items-start space-x-4">
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold mb-2">
                    {service.provider_id?.full_name || "Anonymous"}
                  </h3>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
              ...
              <div className="space-y-4">
                {service.packages &&
                  Object.entries(service.packages).map(([tier, package_]) => (
                    <div
                      key={tier}
