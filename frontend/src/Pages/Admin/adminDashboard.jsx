...
const StatCard = ({ title, value, icon, bgColor }) => (
  <div className="bg-white p-6 rounded-xl shadow-sm flex items-center">
    <div
      className={`rounded-xl w-14 h-14 flex items-center justify-center ${bgColor} mr-4`}
    >
      {icon}
    </div>
    <div>
  ...
  return (
    <Component
      ...
      className={`flex items-center space-x-3 p-4 rounded-xl transition-all duration-300 w-full ${
        active
          ? "bg-[#347486] text-white"
          : "text-gray-600 hover:bg-[#347486]/10"
      }`}
    >
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <main className="p-6">
          ...
          {location.pathname === "/admin/AdvertisingManagement" && (
