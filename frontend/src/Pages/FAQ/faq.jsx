...
const CreateFaq = () => {
  ...
  const handleSubmit = async (e) => { // Declare as async
    e.preventDefault();
    ...
    try {
      ...
      showToast("Failed to create FAQ.", true);
      setSubmitLoading(false);
    }
  };
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  <div className="flex items-center space-x-4">
                    <a href="/faqList" className="w-1/2 flex justify-center items-center py-4 px-4 border border-gray-300 rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 transition-all duration-200"
