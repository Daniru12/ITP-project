...
// Count routes
userRouter.get("/count/users", protect, getUsersCount);
userRouter.get("/count/services", protect, getServicesCount);
userRouter.get("/count/pets", protect, getPetsCount);
